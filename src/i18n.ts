...
export type UIStrings = {
  ...
  aiDisclaimer: string
  close: string
  /** Chat header X — returns to in-panel launcher tab. */
  ...
  dismiss: string
  /** Optional: section label above suggested questions in modal empty state. */
  exampleQuestions?: string
  /** Optional: header button tooltips for the wide-panel toggle. Fallback
   * is the English literal so omitting them is safe. */
  expand?: string
  collapse?: string
  /** Support-form deflector copy (mode=deflector). */
  deflectorTitle?: string
  deflectorGreeting?: string
  deflectorResolved?: string
  deflectorContinue?: string
}
...
const en: UIStrings = {
  ...
  dismiss: 'Dismiss',
  deflectorTitle: 'Search docs first',
  deflectorGreeting: 'We might already have an answer in the docs. Searching before you submit can save time.',
  deflectorResolved: 'This answered my question',
  deflectorContinue: 'Continue to support',
}
...
const tr: UIStrings = {
  ...
  close: 'Kapat',
  backToLauncher: 'Başlatıcıya dön',
  attach: 'Görsel ekle',
  send: 'Gönder',
  ...
  dismiss: 'Kapat',
  deflectorTitle: 'Önce dokümanlara bak',
  deflectorGreeting: 'Cevap dokümanlarda olabilir. Göndermeden önce aramak zaman kazandırır.',
  deflectorResolved: 'Sorum cevaplandı',
  deflectorContinue: 'Destek talebine devam et',
}
